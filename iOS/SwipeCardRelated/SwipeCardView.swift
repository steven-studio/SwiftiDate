...
struct SwipeCardView: View {
    ...
    func cardProperties(for user: Profile) -> (isCurrentCard: Bool, rotationAngle: Double, zIndexValue: Double, scaleValue: CGFloat) {
    ...
    func loadUsers(pageSize: Int = 20, lastDocument: DocumentSnapshot? = nil) {
        ...
        query.getDocuments { snapshot, error in
            ...
            for doc in docs {
                ...
                tempUsers.append(Profile(id: id, data: data))
            }
