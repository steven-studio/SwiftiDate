...
class GenerateTelemetry {
  ...
  inputVideos = new MetricCounter(this._N("generate/input/videos"), {
    description: "Counts input videos to a Genkit model.",
    valueType: ValueType.INT
  });
  inputAudio = new MetricCounter(this._N("generate/input/audio"), {
  ...
  outputVideos = new MetricCounter(this._N("generate/output/videos"), {
    description: "Count output videos from a Genkit model.",
    valueType: ValueType.INT
  });
  outputAudio = new MetricCounter(this._N("generate/output/audio"), {
