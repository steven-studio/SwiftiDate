...
class GenerateTelemetry {
  ...
  inputVideos = new import_metrics.MetricCounter(this._N("generate/input/videos"), {
    description: "Counts input videos to a Genkit model.",
    valueType: import_api.ValueType.INT
  });
  inputAudio = new import_metrics.MetricCounter(this._N("generate/input/audio"), {
  ...
  outputVideos = new import_metrics.MetricCounter(this._N("generate/output/videos"), {
    description: "Count output videos from a Genkit model.",
    valueType: import_api.ValueType.INT
  });
  outputAudio = new import_metrics.MetricCounter(this._N("generate/output/audio"), {
  ...
  recordGenerateActionConfigLogs(span, model, featureName, qualifiedPath, input, projectId, sessionId, threadName) {
    ...
    import_logging.logger.logStructured(`Config[${path}, ${model}]`, {
      ...
      stopSequences: (0, import_utils.truncate)(input.config?.stopSequences, 1024),
      source: "ts",
      sourceVersion: import_genkit.GENKIT_VERSION
    });
  }
